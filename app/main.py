...
from app.slack_ingestion_service import start_slack_ingestion, start_socket_mode, validate_slack_tokens
...
async def lifespan(app: FastAPI):
    ...
    try:
        await asyncio.wait_for(asyncio.gather(slack_ingestion_task, socket_mode_task), timeout=5.0)
