ALTER TABLE
    IF EXISTS thread_messages DROP CONSTRAINT IF EXISTS thread_messages_channel_id_fkey;

ALTER TABLE
    IF EXISTS thread_messages DROP CONSTRAINT IF EXISTS thread_messages_channel_id_slack_parent_ts_fkey;
